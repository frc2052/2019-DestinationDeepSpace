package com.team2052.deepspace.auto.paths.RightRocketStarts;
...
public class RMiddleRocketStartRightRocketPickUpPath extends Path{

    public RMiddleRocketStartRightRocketPickUpPath() {

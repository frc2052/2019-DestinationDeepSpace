...
public class RStartSideRightCloseHatchPath extends Path {
    ...
    public RStartSideRightCloseHatchPath(Position2d startPos, Direction direction) {
        ...
        addWaypoint(new Waypoint(new Position2d(190,84),Constants.Autonomous.kAutoVelocity));//188, -84
        addWaypoint(new Waypoint(new Position2d(189,75),Constants.Autonomous.kAutoVelocity)); //185 -75
        OptimizePath();
    }
